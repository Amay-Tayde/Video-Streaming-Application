...
function Modal() {
  ...
  return (
    <MuiModal 
        open={showModal} 
        onClose={handleClose}
        className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-4xl overflow-hidden 
        overflow-y-scroll rounded-md scrollbar-hide" 
    >
        <>
            <button className="modalButton absolute right-5 top-5 !z-40 h-9 w-9 border-none
            ...
            <div className="relative pt-[56.25%]">
                <ReactPlayer
                    ...
                    playing
                    muted={muted}  //If want muted videos
                />
